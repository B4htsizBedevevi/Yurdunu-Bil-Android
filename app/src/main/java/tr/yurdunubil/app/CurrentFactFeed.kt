...
object CurrentFactFeed {
    val all = listOf(
        CurrentFact("En büyük yüz ölçümü", "Konya", "Türkiye'nin yüz ölçümü bakımından en büyük ili Konya'dır. 2025 ADNKS bülteninde Konya bu özellikle birlikte veriliyor.", "TÜİK", "2025", "map"),
        CurrentFact("En düşük nüfus yoğunluğu", "Tunceli • 11 kişi/km²", "2025 ADNKS sonuçlarında nüfus yoğunluğu en düşük il Tunceli oldu.", "TÜİK", "2025", "population"),
        CurrentFact("Bal üretiminde lider", "Ordu • 13.001 ton", "2024 yılında Türkiye toplam bal üretiminin %13,6'sı Ordu'da gerçekleşti ve il ilk sırada yer aldı.", "Tarım ve Orman Bakanlığı", "2024", "agriculture"),
        CurrentFact("Türkiye bal üretimi", "95.492 ton", "2024 yılında Türkiye'nin bal üretimi yaklaşık 95,5 bin ton olarak gerçekleşti.", "Tarım ve Orman Bakanlığı", "2024", "agriculture"),
        CurrentFact("2025 bal üretimi", "97.253 ton", "Türkiye'de 2025 yılında toplam bal üretimi 97.253 ton olarak açıklandı.", "Tarım ve Orman Bakanlığı", "2025", "agriculture"),
        CurrentFact("Borun önemli merkezi", "Eskişehir • Kırka", "Kırka, Türkiye'nin başlıca bor yataklarından biridir; bor alanları Batı Anadolu'da yoğunlaşır.", "Enerji ve Tabii Kaynaklar Bakanlığı", "2026", "mine"),
        CurrentFact("Bor üretimindeki konum", "Dünya lideri", "Enerji Bakanlığına göre Türkiye 2024'te dünya bor üretiminin %48'ini karşıladı.", "Enerji ve Tabii Kaynaklar Bakanlığı", "2026", "speed"),
        CurrentFact("Taş kömürü", "Zonguldak", "Zonguldak çevresi Türkiye'de taş kömürü ile özdeşleşen başlıca sahadır.", "KPSS temel bilgi", "2026", "mine"),
        CurrentFact("Petrol", "Batman", "Batman ve çevresi Türkiye'nin önemli petrol üretim alanlarından biridir.", "KPSS temel bilgi", "2026", "mine"),
