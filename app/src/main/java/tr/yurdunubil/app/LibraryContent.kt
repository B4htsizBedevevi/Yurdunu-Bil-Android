...
object LibraryContent {
    val topics = listOf(
        LibraryTopic("Coğrafi Konum", "map", "Mutlak konum, özel konum ve jeopolitik sonuçları birlikte öğren.", listOf(
        ...
        LibraryTopic("Yer Şekilleri", "mountain", "Dağ, ova, plato, vadi ve kıyı şekillerini neden-sonuç ilişkisiyle öğren.", listOf(
        ...
        LibraryTopic("Su Varlığı", "water", "Akarsular, göller, havzalar ve kıyıların sınavda nasıl yorumlandığını öğren.", listOf(
        ...
        LibraryTopic("İklim ve Bitki Örtüsü", "climate", "İklim tiplerini sıcaklık-yağış-bitki üçlüsüyle bağla.", listOf(
        ...
        LibraryTopic("Nüfus ve Yerleşme", "population", "Nüfusun neden bazı alanlarda yoğun, bazılarında seyrek olduğunu çöz.", listOf(
        ...
        LibraryTopic("Tarım ve Hayvancılık", "agriculture", "Ürünü ezberlemek yerine iklim, toprak, sulama ve pazar bağlantısını kur.", listOf(
        ...
        LibraryTopic("Maden ve Enerji", "mine", "Maden-merkez eşleştirmelerini harita mantığıyla öğren.", listOf(
        ...
        LibraryTopic("Sanayi ve Ulaşım", "factory", "Sanayinin ve ulaşımın yer seçimini pazar, ham madde, enerji ve ulaşım üzerinden yorumla.", listOf(
        ...
        LibraryTopic("Turizm", "tourism", "Doğal ve kültürel turizm merkezlerini oluşum nedenleriyle eşleştir.", listOf(
        ...
        LibraryTopic("Bölgeler", "region", "7 bölgeyi sadece isimle değil, ayırt edici özellikleriyle karşılaştır.", listOf(
        ...
        LibraryTopic("Doğal Afetler", "danger", "Afetleri tek tek ezberlemek yerine oluşum koşullarını bağla.", listOf(
        ...
        LibraryTopic("Harita Bilgisi", "map", "Ölçek, izohips ve harita yorumlama sorularında temel kuralları otomatikleştir.", listOf(
